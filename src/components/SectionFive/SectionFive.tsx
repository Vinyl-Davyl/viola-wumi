    ...
    <section id="section-five" data-scroll-section>
      <div id="target-element" className={S.section}>
        ...
        <div className={S.textWrapper}>
          <p className={S.text}>
            Minimalism has arrived in a totally new silhouette. The York & Dante collection is manufactured with the
            highest quality working to blend the right amount of luxury, exclusivity and simplicity. Our brand dedicates
            itself to unique pieces that are standard in its product line and can easily become your wardrobe's
            complement without losing your personality or creativity. Our bond is to create timeless pieces that provide
            ceaseless elegance. The garments are built to be worn from the city to the mountains: made of eco-friendly
            materials that are handmade within an ethical manufacturing process. All you need to do is add an attitude
            of confidence and our pieces take care of the rest. Find your style and story within this collection, and
